...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Hell Maiden Wiki',
    description:
      'How Hell Maiden Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#0d0710] py-12 text-[#fff3fb]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#cbb9ce]">
          Hell Maiden Wiki uses essential cookies and similar technologies to
        ...
        <p className="leading-8 text-[#cbb9ce]">
          Questions about this policy can be sent to hello@hell-maiden.wiki.
        </p>
      </Container>
    </div>
  );
