...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-[#4c2d52] border-t bg-[#0d0710] text-[#fff3fb]',
        className
      )}
    >
      ...
      <div className="border-[#4c2d52] border-t py-8">
        <Container className="flex flex-col gap-3 px-4 md:flex-row md:items-center md:justify-between">
          ...
          <span className="text-muted-foreground text-sm">
            Independent Hell Maiden guide site. Not affiliated with AstralShift,
