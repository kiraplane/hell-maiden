...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    ...
    social: {
      ...
      twitter: '',
      blueSky: '',
      discord: 'https://discord.gg/Hn5dkbAZR5',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/@astralshiftpro/videos',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Hell Maiden Wiki <hello@hell-maiden.wiki>',
