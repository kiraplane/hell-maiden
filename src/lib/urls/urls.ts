...
export const CANONICAL_BASE_URL = 'https://www.hell-maiden.wiki';
...
function getHellMaidenBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'hell-maiden.wiki' ||
      parsedUrl.hostname === 'www.hell-maiden.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const hellMaidenBaseUrl = getHellMaidenBaseUrl(configuredBaseUrl);
  if (hellMaidenBaseUrl) {
    return hellMaidenBaseUrl;
  }
