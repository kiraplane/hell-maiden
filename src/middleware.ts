...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/combat(?:\/.*)?$/, target: '/guides/best-builds' },
  {
    pattern: /^\/map(?:\/.*)?$/,
    target: '/guides',
  },
  { pattern: /^\/steam\/?$/, target: '/download' },
  { pattern: /^\/pc\/?$/, target: '/download' },
  { pattern: /^\/requirements\/?$/, target: '/download' },
  { pattern: /^\/buy\/?$/, target: '/download' },
  { pattern: /^\/apk(?:\/.*)?$/, target: '/download' },
  {
    pattern: /^\/hell-maiden-beginner-guide(?:\/.*)?$/,
    target: '/guides/beginner-guide',
  },
  {
    pattern: /^\/hell-maiden-map(?:\/.*)?$/,
    target: '/guides',
  },
  {
    pattern: /^\/hell-maiden-download(?:\/.*)?$/,
    target: '/download',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set(['hell-maiden.wiki', 'www.hell-maiden.wiki']);
  const canonicalHost = 'www.hell-maiden.wiki';
